...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        testSolutionRecursiveTwoSidedBfs1();
        testSolutionRecursiveTwoSidedBfs2();
        testSolutionRecursiveTwoSidedBfs1();
    }
    ...
    public static void test3() {
        ...
        String endWord = "ism";
        List<String> dict = Arrays.asList("kid", "tag", "pup", "ail", "tun", "woo", "erg", "luz", "brr",
                "gay", "sip", "kay", "per",
                ...
                "mob");
        Solution s = new Solution();
        int output = s.ladderLength(beginWord, endWord, dict);
    ...
    public static void testSolutionRecursiveTwoSidedBfs1() {
        SolutionRecursiveTwoSidedBfs s = new SolutionRecursiveTwoSidedBfs();
        int output = s.ladderLength(
                "hit",
                "cog",
                Arrays.asList(new String[] { "hot", "dot", "dog", "lot", "log", "cog" }));
        boolean passed = output == 5;
        System.out.println("testSolutionRecursiveTwoSidedBfs1: " + (passed ? "passed" : "failed"));
    }

    public static void testSolutionRecursiveTwoSidedBfs2() {
        SolutionRecursiveTwoSidedBfs s = new SolutionRecursiveTwoSidedBfs();
        int output = s.ladderLength(
                "hit",
                "cog",
                Arrays.asList(new String[] { "hot", "dot", "dog", "lot", "log" }));
        boolean passed = output == 0;
        System.out.println("testSolutionRecursiveTwoSidedBfs2: " + (passed ? "passed" : "failed"));
    }

    public static void testSolutionRecursiveTwoSidedBfs3() {
        String beginWord = "cet";
        String endWord = "ism";
        List<String> dict = Arrays.asList("kid", "tag", "pup", "ail", "tun", "woo", "erg", "luz", "brr",
                "gay", "sip", "kay", "per",
        ...
        int output = s.ladderLength(beginWord, endWord, dict);
        boolean passed = output == 11;
        System.out.println("testSolutionRecursiveTwoSidedBfs3: " + (passed ? "passed" : "failed"));
    }
