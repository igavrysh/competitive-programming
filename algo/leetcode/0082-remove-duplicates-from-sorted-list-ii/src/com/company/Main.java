...
public class Main {
  ...
  public static void test1() {
    ...
    System.out.println("test1: " + (passed ? "pased" : "failed"));
  }
  ...
  public static void test2() {
    ...
    System.out.println("test2: " + (passed ? "pased" : "failed"));
  }
  ...
  public static void test3() {
    ...
    boolean passed = output.val == 1
        && output.next == null;
    System.out.println("test3: " + (passed ? "pased" : "failed"));
  }
  ...
  public static void test4() {
    ...
    System.out.println("test4: " + (passed ? "pased" : "failed"));
  }
  ...
  public static void test5() {
    ...
    ListNode output = s.deleteDuplicates(input);
    boolean passed = output == null;
    System.out.println("test5: " + (passed ? "pased" : "failed"));
  }
