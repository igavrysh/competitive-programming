...
public class Main {
    ...
    public static void testLFUCacheTwoHashMapsNMinFqVar1() {
        ...
        System.out.println(
                getMethodName() + " - getting element 1 - should rearrange list: " + (passed ? "passed" : "failed"));
        ...
        passed = passed
                ...
                && cache.fq.get(1).sentinel.next == cache.nodes.get(2)
                && cache.fq.get(1).sentinel.prev == cache.nodes.get(2);
        System.out.println(getMethodName() + " - getting element 1 again - no rearrangments are expected: "
    ...
    public static void testLFUCacheTwoHashMapsNMinFqVar2() {
        ...
        System.out.println(
                getMethodName() + " - getting element 2 - should rearrange list: " + (passed ? "passed" : "failed"));
