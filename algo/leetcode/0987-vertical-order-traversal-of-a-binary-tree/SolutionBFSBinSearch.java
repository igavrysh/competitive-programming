...
public class SolutionBFSBinSearch {
    ...
    public List<List<Integer>> verticalTraversal(TreeNode root) {
        ...
        while (!q.isEmpty()) {
            ...
            for (int l = 0; l < lsize; l++) {
                ...
                */
                int insertIdx = sz == 0 ? a.size() : bs(node.val, a.size()-sz, a.size()-1, a);
    ...
    private int bs(int val, int l, int r, ArrayList<Integer> a) {
        int bad = l-1;
        int good = r+1;
        while (good - bad > 1) {
    ...
    public static void test4() {
        ...
        SolutionBFSBinSearch sol = new SolutionBFSBinSearch();
